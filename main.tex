...
\usepackage[a4paper, total={16cm,24cm},textheight=22.5cm, top=4cm]{geometry}
...
\fancyhf{}
\rhead{\today}
\chead{Teknisk Rapport: Polsens kvalitet}
\lhead{Kursus 02526}
\rfoot{Side \thepage}
\lfoot{ s133789 | 133130 | 141192}
...
\title{Teknisk Rapport: Polsens kvalitet}
\author{
    Mikkel Asbjørn F. Andersen & s133789\\
    Christian Aaskov Frausing & s133130\\
    Sebastian Dahl Meier & s141192\\}
...
\makeatletter
    ...
    Sebastian Dahl Meier & s141192\\
       ...
       \small 02526 | Matematisk modellering
    \end{center}
\end{titlepage}
\begin{abstract}
...
\section{Eksempler}
%eksempler på kode til for eksempel formler grafik mv.
